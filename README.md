...
Now you're all set up. Navigate your way into the project's directory and write 
# npm install or yarn install. 
This will install all dependencies that Now UI React Native needs in order to function properly.

Now write 
# expo start 
and you're ready to go. A new window will pop-up in your default browser. This is your localhost's dashboard. Open up your favorite text editor/IDE and an Android/iOS simulator.
